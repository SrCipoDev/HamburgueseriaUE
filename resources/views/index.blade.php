        ...
        <div class="row justify-content-center">
            <div class="col-sm-7 col-md-4 mb-5">
                ...
                <ul class="nav nav-pills nav-justified mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#hamburguesas"
                            role="tab" aria-controls="pills-home" aria-selected="true">Hamburguesas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#bocadillos" role="tab"
                            aria-controls="pills-profile" aria-selected="false">Bocadillos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#acompañamientos"
                            role="tab" aria-controls="pills-profile" aria-selected="false">Acompañamientos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#ensalada" role="tab"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#bebidas" role="tab"
                            aria-controls="pills-profile" aria-selected="false">Bebidas</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="card bg-transparent border my-3 my-md-0">
                            <a href="" alt="">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-white"> Disfruta de una exquisita selección de Hamburguesas Gourmet de
                                        Ternera, preparadas con la más alta calidad de carne de ternera, jugosas y llenas de
                                        sabor. ¡una verdadera delicia para tu paladar!</p>
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <a href="" alt="">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-white"> Descubre nuestra deliciosa selección de Hamburguesas Gourmet de
                                    Pollo, elaboradas con jugosa carne de pollo premium y sazonadas con una mezcla especial
                                    que realzan su sabor. </p>
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <a href="" alt="">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-white"> Explora nuestra variedad de Hamburguesas Gourmet Vegetales, elaboradas
                                con una mezcla de verduras frescas, legumbres y especias seleccionadas para ofrecerte una
                                opción deliciosa y nutritiva. </p>
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="card bg-transparent border">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa provident
                            illum officiis fugit laudantium voluptatem sit iste delectus qui ex. </p>
                    </div>
                </div>
            </div>
            <!-- BOCADILLOS DE POLLO-->
